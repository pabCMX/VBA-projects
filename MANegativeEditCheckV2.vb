...
Sub Find_Write_Database_Files()
    ...
    For i = 2 To maxrow
        ...
        '
        ' MA Negative file naming: "Review Number {ReviewNum} Month {YYYYMM} Examiner*.xls*"
        ' Unlike TANF, MA Negative files are not in case folders - they're directly in the program folder (or month subfolder).
